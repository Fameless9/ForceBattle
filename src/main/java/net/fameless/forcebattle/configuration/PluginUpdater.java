...
public class PluginUpdater {
    ...
    private static final ForceBattle forceBattle = ForceBattle.get();
    ...
    private static final String PLUGIN_DIRECTORY = forceBattle.getPluginFile().getParent();
    private static final String CURRENT_PLUGIN_FILE = forceBattle.getPluginFile().getAbsolutePath();
    ...
    public static void checkForUpdate() {
        try {
            ...
            String currentVersion = forceBattle.getPluginVersion();
