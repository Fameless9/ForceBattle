    ...
    public void executeCommand(CommandCaller caller, String[] args) {
        ...
        switch (args[0]) {
            ...
            case "join" -> {
                ...
                Optional<net.fameless.core.game.Team> teamOpt = net.fameless.core.game.Team.ofId(teamId);
            ...
            case "list" -> {
                ...
                for (net.fameless.core.game.Team team : net.fameless.core.game.Team.teams) {
